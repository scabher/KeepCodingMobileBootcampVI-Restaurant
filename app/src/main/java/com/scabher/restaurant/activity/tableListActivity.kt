...
import com.scabher.restaurant.model.DummyContent
 ...
 * lead to a [tableDetailActivity] representing
...
class tableListActivity : AppCompatActivity() {
    ...
    class SimpleItemRecyclerViewAdapter(private val parentActivity: tableListActivity,
                ...
                if (twoPane) {
                    val fragment = tableDetailFragment().apply {
                        arguments = Bundle().apply {
                            putString(tableDetailFragment.ARG_ITEM_ID, item.id)
                        }
                    }
                    ...
                    val intent = Intent(v.context, tableDetailActivity::class.java).apply {
                        putExtra(tableDetailFragment.ARG_ITEM_ID, item.id)
                    }
